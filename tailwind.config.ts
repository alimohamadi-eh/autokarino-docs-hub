	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'tab-switch': 'tab-switch 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
			},
			backgroundImage: {
				'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
				'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
				'mesh-gradient': 'linear-gradient(135deg, hsl(var(--primary)/0.1) 0%, hsl(var(--accent)/0.05) 25%, hsl(var(--secondary)/0.1) 50%, hsl(var(--primary)/0.05) 75%, hsl(var(--accent)/0.1) 100%)',
			}
		}
	},
